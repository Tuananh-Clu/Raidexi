  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-0 border border-border-subtle relative bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-4 border rounded-xl bg-[#f1f5f9] shadow-inner border-border-subtle mt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative space-y-1">
                ...
                <div className="text-[#0f172a] font-bold">H: 182.4cm</div>
                <div className="text-[#0f172a] font-bold">C: 104.2cm</div>
      ...
      <div className="relative flex-col items-center justify-center hidden w-24 lg:flex bg-[#1a1713] border-r border-border-subtle">
        <div className="absolute left-0 w-full h-px bg-[#e2e8f0] top-1/2"></div>
        <div className="z-10 p-2 border rounded-full bg-white border-primary/30 shadow-sm">
      ...
      <div className="relative flex items-center justify-center h-16 border-b lg:hidden bg-[#1a1713] border-border-subtle">
        <div className="absolute top-0 w-px h-full bg-[#e2e8f0] left-1/2"></div>
        <div className="z-10 p-2 border rounded-full bg-white border-primary/30 shadow-sm">
      ...
      <div>
        <DiagramLayer
          ...
          description={
            <>
              <span className="text-[#94a3b8] font-medium">// Brand-Owned Ruleset</span>
              <br />
        ...
        >
          <div className="p-4 border rounded-xl bg-[#0d0f0e] shadow-md border-emerald-900/50 mt-4 text-text-muted">
            ...
            <div className="space-y-3 font-mono">
              ...
              <div className="flex items-start gap-3">
                <span className="text-[#94a3b8] mt-0.5">02</span>
                <div>
              ...
              <div className="flex items-start gap-3 border-t border-emerald-900/40 pt-3 mt-3">
                ...
                <div>
                  <span className="text-[#94a3b8]">OUTPUT:</span> <span className="px-2 py-0.5 font-bold text-white bg-emerald-400 rounded">SIZE L (Regular)</span>
                </div>
              </div>
            </div>
          </div>
