  ...
  return (
    <div className="flex flex-col items-start justify-between gap-6 pb-8 mb-12 border-b md:flex-row md:items-end border-border-subtle">
      <div className="max-w-2xl">
        ...
        <h2 className="mb-4 text-4xl font-bold leading-tight text-white md:text-5xl tracking-tight">
      ...
      <div className="flex flex-col items-end gap-2 text-right">
        <div className="font-mono text-xs font-semibold text-text-dim uppercase tracking-wider">REVISION 1.0.4</div>
