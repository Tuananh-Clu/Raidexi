  ...
  return (
    <div className="flex-1">
      <div className="flex flex-col pb-6 mb-8 border-b md:flex-row md:justify-between md:items-start border-dark-700">
        ...
        <button
          onClick={() => back()}
          className="flex items-center gap-2 px-6 py-2 mt-4 text-xs tracking-widest uppercase transition-colors border md:mt-0 border-dark-600 hover:border-white"
        >
      ...
      <div className="p-6 mb-6 border rounded-sm bg-dark-800 border-dark-600">
        ...
        <div className="grid grid-cols-1 gap-8 mb-6 md:grid-cols-2">
          <div>
            <label className="block mb-3 text-xs tracking-wide text-gray-500 uppercase">
              GIỚI TÍNH
            </label>
      ...
      <div className="relative grid grid-cols-1 gap-0 mb-6 overflow-hidden border rounded-sm lg:grid-cols-2 border-primary">
        ...
        <div className="flex flex-col items-center justify-center p-10 border-b lg:border-b-0 lg:border-r border-gray bg-gradient-to-br from-dark-[#121212] to-dark-[#0a0a0a]">
          <span className="text-gray-400 text-xs uppercase tracking-[0.2em] mb-4">
            SIZE ĐƯỢC ĐỀ XUẤT
          </span>
        ...
        <div className="flex flex-col justify-center p-10 bg-dark-800/50">
          <div className="pb-8 mb-8 border-b border-dashed border-dark-600">
            <span className="block mb-2 text-xs tracking-widest text-gray-400 uppercase">
              ĐỘ TIN CẬY
            </span>
      ...
      <div className="p-8 mb-6 border rounded-sm bg-dark-800 border-dark-600">
        <h4 className="flex items-center gap-3 mb-6 font-serif text-lg text-white">
          <Diamond className="text-gold-500 fill-gold-500" size={16} /> LOGIC &
          PHÂN TÍCH CHI TIẾT
        </h4>

        <div className="grid grid-cols-1 gap-10 mb-8 text-sm leading-relaxed text-gray-300 md:grid-cols-2">
          <div>
            <h5 className="pl-3 mb-3 text-xs font-bold tracking-widest uppercase border-l-2 text-gold-500 border-gold-500">
        ...
        <div className="border bg-dark-900 border-dark-700">
          <div className="grid grid-cols-4 px-4 py-3 border-b bg-dark-700 border-dark-600">
            ...
            <div className="text-xs font-bold tracking-wider text-right text-gray-400 uppercase">
              TÌNH TRẠNG
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <button
          onClick={handleSave}
          className="md:col-span-2 bg-primary hover:bg-gold-400 text-black font-bold text-sm uppercase tracking-widest py-4 flex items-center justify-center gap-3 transition-colors shadow-[0_4px_20px_rgba(236,174,24,0.3)]"
        >
          <SaveAllIcon size={18} /> Lưu dữ liệu vào tài khoản của tôi
        </button>
        <button
          onClick={() => navigate("/Brand")}
          className="flex items-center justify-center gap-3 py-4 text-sm font-bold tracking-widest text-white uppercase transition-colors border border-dark-500 hover:border-white bg-dark-800"
        >
