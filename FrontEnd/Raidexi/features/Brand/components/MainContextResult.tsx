    ...
    <div className="flex-1 font-sans">
      <div className="flex flex-col pb-6 mb-8 border-b md:flex-row md:justify-between md:items-start border-border-subtle">
        <div>
          ...
          <p className="font-mono text-xs font-semibold tracking-wider text-text-dim uppercase">
      ...
      <div className="p-6 mb-8 bg-surface-dark border border-border-subtle rounded-2xl shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-8 mb-6 md:grid-cols-2">
          <div>
            <label className="block mb-3 text-xs font-bold tracking-wide text-text-dim uppercase">
              GIỚI TÍNH
            </label>
                ...
                <button
                  ...
                  className={`py-3 text-sm font-bold transition-colors ${
                    activeGender === gender.toUpperCase()
                      ...
                      : "bg-surface-dark text-text-dim hover:bg-surface-hover hover:text-white"
                  }`}
                >
                  {gender}
                </button>
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all border ${
                  activeRegion === region.toUpperCase()
                    ...
                    : "bg-surface-dark border-border-subtle text-text-dim hover:border-primary/30 hover:text-primary hover:bg-primary/5"
                }`}
              >
                {region}
              </button>
      ...
      <div className="relative grid grid-cols-1 gap-0 mb-8 overflow-hidden bg-surface-dark border border-border-subtle rounded-2xl shadow-sm lg:grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center p-10 border-b lg:border-b-0 lg:border-r border-border-subtle bg-[#15120e]">
          <span className="text-text-dim text-[11px] font-bold uppercase tracking-[0.2em] mb-4">
            SIZE ĐƯỢC ĐỀ XUẤT
          </span>
          <span className="text-[120px] leading-none font-bold text-white drop-shadow-sm tracking-tighter">
        ...
        <div className="flex flex-col justify-center p-10 bg-surface-dark">
          <div className="pb-8 mb-8 border-b border-dashed border-border-subtle">
            <span className="block mb-2 text-xs font-bold tracking-widest text-text-dim uppercase">
              ĐỘ TIN CẬY
            </span>
            ...
            <div className="w-full h-1.5 mt-5 bg-[#2a241d] rounded-full overflow-hidden">
              <div
      ...
      {/* Logic Analysis */}
      <div className="p-8 mb-8 bg-surface-dark border border-border-subtle rounded-2xl shadow-sm">
        <h4 className="flex items-center gap-3 mb-6 font-bold tracking-wide text-lg text-white uppercase">
        ...
        <div className="overflow-hidden border border-border-subtle rounded-xl">
          <div className="grid grid-cols-4 px-5 py-4 border-b bg-[#15120e] border-border-subtle">
            <div className="text-[11px] font-bold tracking-wider text-text-dim uppercase">
              SIZE
            </div>
            <div className="text-[11px] font-bold tracking-wider text-text-dim uppercase">
              NGỰC (CHEST)
            ...
            <div className="text-[11px] font-bold tracking-wider text-right text-text-dim uppercase">
              TÌNH TRẠNG
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 py-4 text-sm font-bold tracking-widest text-text-muted uppercase transition-all bg-surface-dark border border-border-subtle rounded-xl hover:bg-surface-hover hover:text-white hover:border-border-brass shadow-sm"
        >
