    ...
    <section className="w-full px-6 lg:px-12 pb-24 max-w-[1400px]">
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <h3 className="font-mono text-sm font-bold tracking-widest text-[#0f172a] uppercase">
            System Specifications
          </h3>
        </div>
        
        <div className="w-full overflow-hidden border border-border-subtle bg-[#f8fafc]">
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="font-sans text-sm">
                {specs.map((row, index) => (
                  ...
                  >
                    <td className="p-4 font-bold text-[#0f172a] border-r border-border-subtle">{row.object}</td>
