    ...
    <div className="flex flex-col gap-4 w-72 shrink-0 group">
      <div 
        className={`
          ...
          ${isDefault 
            ? 'border border-border-subtle bg-[var(--surface-canvas)] group-hover:border-primary' 
            : 'border border-primary bg-[var(--ink)] shadow-[0_0_24px_-12px_rgba(93,116,101,0.28)]'
          }
        `}
      >
        ...
        <div className="flex flex-col">
          ...
          <span className="font-mono text-sm font-bold text-[var(--ink)]">{title}</span>
        </div>
