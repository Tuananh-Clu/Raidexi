        ...
        <main className="flex flex-col items-center flex-1 px-6 py-12 md:px-20">
          ...
          >
              ...
              <table className="w-full text-left min-w-[800px]">
                <thead>
                  <tr className="bg-primary/5">
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">US Size</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">UK</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">EU</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">Chest (cm)</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">Waist (cm)</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">Hip (cm)</th>
                    <th className="px-6 py-5 text-xs font-semibold tracking-widest uppercase text-primary">Height (cm)</th>
                  </tr>
                </thead>
            ...
            >
              <div className="flex items-center gap-2 text-primary/40">
                ...
                <p className="font-mono text-xs tracking-widest uppercase">
                  Units measured in Centimeters (cm). For precise fit, measure against skin.
                </p>
              </div>
              <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium tracking-[0.15em] uppercase text-primary border border-primary/20 hover:bg-primary/10 transition-colors">
            ...
            <motion.div 
              ...
              className="pt-8 mt-20 text-center border-t border-primary/10"
            >
              <p className="text-[10px] uppercase tracking-[0.5em] text-primary font-mono">
                Raidexi Technical Manufacturing Division © MMXXIV
              </p>
            </motion.div>
          </div>
        </main>
